...
enum L10n {
    enum Key: String, Hashable {
        ...
        case providerIcons
        case providerIconsHelp
        case providerIconOpenAI
        case providerIconCodexLight
        case providerIconCodexDark
    ...
    private static let translations: [AppLanguage: [Key: String]] = [
        .simplifiedChinese: [
            ...
            .softwareUpdate: "软件更新",
            .softwareUpdateHelp: "每天按本机时间 11:00 检查 GitHub Releases；错过时在下次启动或唤醒后补查。有新版本可一键下载、校验、安装并重启。",
            ...
            .credentialsFooter: "仅 MiniMax Token Plan 密钥和 QwenWork 个人 Access Token 可用于读取服务端额度。Codex 登录态自动读取，无需添加；QwenWork 企业 API Key 不适用。凭据保存在 macOS 钥匙串。",
            .sidebarOrder: "侧边栏 AI 工具顺序",
            .sidebarOrderHelp: "侧边栏和完整概览会按照这里的顺序显示。拖动工具，或使用右侧箭头调整位置。",
            .providerIcons: "AI 工具图标",
            .providerIconsHelp: "仅列出提供多个官方图标的工具；选择后，侧边栏、概览和宠物信息中的图标会立即更新。",
            .providerIconOpenAI: "OpenAI 标志",
            .providerIconCodexLight: "Codex 浅色",
            .providerIconCodexDark: "Codex 深色",
        ...
        .english: [
            ...
            .softwareUpdateHelp: "Checks GitHub Releases daily at 11:00 local time; missed checks run after launch or wake. One click downloads, verifies, installs, and restarts the app.",
            ...
            .credentialsFooter: "Only MiniMax Token Plan keys and QwenWork personal access tokens can read server quotas here. Codex sign-in is read automatically; QwenWork enterprise API keys are not supported. Credentials are stored in the macOS Keychain.",
            ...
            .providerIcons: "AI Tool Icons",
            .providerIconsHelp: "Only tools with multiple official icons appear here. Your choice updates the sidebar, overview, and pet activity immediately.",
            .providerIconOpenAI: "OpenAI Logo",
            .providerIconCodexLight: "Codex Light",
            .providerIconCodexDark: "Codex Dark",
        ...
        .japanese: [
            ...
            .softwareUpdateHelp: "毎日、現地時刻の11:00にGitHub Releasesを確認します。確認できなかった場合は起動時またはスリープ解除後に実行します。新しいバージョンはワンクリックでダウンロード、検証、インストール、再起動できます。",
            ...
            .credentialsFooter: "サーバー側の利用枠を取得できるのは MiniMax Token Plan のキーと QwenWork 個人用 Access Token のみです。Codex のログイン状態は自動取得されます。QwenWork の企業向け API Key は使用できません。認証情報は macOS キーチェーンに保存されます。",
            .sidebarOrder: "サイドバー AI ツールの順序",
            .sidebarOrderHelp: "サイドバーと完全な概要はこの順序で表示されます。ドラッグまたは矢印で並べ替えます。",
            .providerIcons: "AIツールのアイコン",
            .providerIconsHelp: "複数の公式アイコンがあるツールのみ表示します。選択はサイドバー、概要、ペットの表示にすぐ反映されます。",
            .providerIconOpenAI: "OpenAI ロゴ",
            .providerIconCodexLight: "Codex ライト",
            .providerIconCodexDark: "Codex ダーク",
        ...
        .korean: [
            ...
            .softwareUpdateHelp: "매일 현지 시간 11:00에 GitHub Releases를 확인합니다. 놓친 검사는 다음 실행 또는 절전 해제 후 진행합니다. 새 버전은 한 번의 클릭으로 다운로드, 검증, 설치 후 재시작합니다.",
            ...
            .credentialsFooter: "서버 사용 한도 조회에는 MiniMax Token Plan 키와 QwenWork 개인 Access Token만 사용할 수 있습니다. Codex 로그인은 자동으로 읽으며, QwenWork 기업용 API Key는 지원하지 않습니다. 자격 증명은 macOS 키체인에 저장됩니다.",
            .sidebarOrder: "사이드바 AI 도구 순서",
            .sidebarOrderHelp: "사이드바와 전체 개요가 이 순서로 표시됩니다. 도구를 드래그하거나 화살표로 이동하세요.",
            .providerIcons: "AI 도구 아이콘",
            .providerIconsHelp: "공식 아이콘이 여러 개인 도구만 표시합니다. 선택하면 사이드바, 개요, 펫 활동에 즉시 반영됩니다.",
            .providerIconOpenAI: "OpenAI 로고",
            .providerIconCodexLight: "Codex 라이트",
            .providerIconCodexDark: "Codex 다크",
    ...
    private static let additionalTranslations: [AppLanguage: [Key: String]] = [
        .traditionalChinese: [
            ...
            .softwareUpdate: "軟體更新",
            .softwareUpdateHelp: "每天依本機時間 11:00 檢查 GitHub Releases；錯過時會在下次啟動或喚醒後補查。有新版本可一鍵下載、驗證、安裝並重新啟動。",
            ...
            .credentialsFooter: "只有 MiniMax Token Plan 金鑰與 QwenWork 個人 Access Token 可用於讀取伺服器額度。Codex 登入狀態會自動讀取，無須新增；QwenWork 企業 API Key 不適用。憑證會儲存在 macOS 鑰匙圈。",
            .sidebarOrder: "側邊欄 AI 工具順序",
            .sidebarOrderHelp: "側邊欄與完整概覽會依照這裡的順序顯示。拖曳工具或使用箭頭調整位置。",
            .providerIcons: "AI 工具圖示",
            .providerIconsHelp: "僅列出提供多款官方圖示的工具；選擇後，側邊欄、概覽與寵物資訊中的圖示會立即更新。",
            .providerIconOpenAI: "OpenAI 標誌",
            .providerIconCodexLight: "Codex 淺色",
            .providerIconCodexDark: "Codex 深色",
        ...
        .spanish: [
            ...
            .softwareUpdateHelp: "Comprueba GitHub Releases cada día a las 11:00, hora local. Si se pierde la hora, comprueba al abrirse o al despertar. Un clic descarga, verifica, instala y reinicia la app.",
            ...
            .credentialsFooter: "Aquí solo se pueden consultar cuotas del servidor con una clave MiniMax Token Plan o un token de acceso personal de QwenWork. El inicio de sesión de Codex se lee automáticamente; las claves API empresariales de QwenWork no sirven. Las credenciales se guardan en el Llavero de macOS.",
            ...
            .providerIcons: "Iconos de herramientas de IA",
            .providerIconsHelp: "Solo aparecen herramientas con varios iconos oficiales. La elección se aplica al instante a la barra lateral, el resumen y la mascota.",
            .providerIconOpenAI: "Logotipo de OpenAI",
            .providerIconCodexLight: "Codex claro",
            .providerIconCodexDark: "Codex oscuro",
        ...
        .french: [
            ...
            .softwareUpdateHelp: "Vérifie GitHub Releases chaque jour à 11 h, heure locale. Une vérification manquée a lieu au lancement ou au réveil. Un clic télécharge, vérifie, installe et redémarre l’app.",
            ...
            .credentialsFooter: "Seules une clé MiniMax Token Plan et un jeton d’accès personnel QwenWork permettent de lire les quotas serveur ici. La connexion Codex est détectée automatiquement ; les clés API d’entreprise QwenWork ne conviennent pas. Les identifiants sont conservés dans le trousseau macOS.",
            ...
            .providerIcons: "Icônes des outils IA",
            .providerIconsHelp: "Seuls les outils ayant plusieurs icônes officielles apparaissent ici. Le choix s’applique aussitôt à la barre latérale, à l’aperçu et au compagnon.",
            .providerIconOpenAI: "Logo OpenAI",
            .providerIconCodexLight: "Codex clair",
            .providerIconCodexDark: "Codex sombre",
        ...
        .german: [
            ...
            .softwareUpdateHelp: "Prüft GitHub Releases täglich um 11:00 Uhr Ortszeit. Verpasste Prüfungen erfolgen beim nächsten Start oder Aufwachen. Ein Klick lädt das Update, prüft und installiert es und startet die App neu.",
            ...
            .credentialsFooter: "Serverkontingente lassen sich hier nur mit einem MiniMax-Token-Plan-Schlüssel oder einem persönlichen QwenWork-Access-Token abrufen. Die Codex-Anmeldung wird automatisch erkannt; QwenWork-Unternehmens-API-Schlüssel funktionieren nicht. Zugangsdaten werden im macOS-Schlüsselbund gespeichert.",
            ...
            .providerIcons: "Symbole für KI-Werkzeuge",
            .providerIconsHelp: "Hier erscheinen nur Werkzeuge mit mehreren offiziellen Symbolen. Die Auswahl gilt sofort für Seitenleiste, Übersicht und Haustieranzeige.",
            .providerIconOpenAI: "OpenAI-Logo",
            .providerIconCodexLight: "Codex Hell",
            .providerIconCodexDark: "Codex Dunkel",
        ...
        .italian: [
            ...
            .softwareUpdateHelp: "Controlla GitHub Releases ogni giorno alle 11:00 ora locale. I controlli persi avvengono all’avvio o al risveglio. Un clic scarica, verifica, installa e riavvia l’app.",
            ...
            .credentialsFooter: "Qui le quote del server si possono leggere solo con una chiave MiniMax Token Plan o un token di accesso personale QwenWork. L’accesso Codex viene rilevato automaticamente; le chiavi API aziendali QwenWork non sono supportate. Le credenziali sono salvate nel Portachiavi di macOS.",
            ...
            .providerIcons: "Icone degli strumenti IA",
            .providerIconsHelp: "Qui compaiono solo gli strumenti con più icone ufficiali. La scelta aggiorna subito barra laterale, panoramica e attività della mascotte.",
            .providerIconOpenAI: "Logo OpenAI",
            .providerIconCodexLight: "Codex chiaro",
            .providerIconCodexDark: "Codex scuro",
        ...
        .portugueseBrazil: [
            ...
            .softwareUpdateHelp: "Verifica o GitHub Releases diariamente às 11h no horário local. Verificações perdidas ocorrem ao iniciar ou despertar. Um clique baixa, verifica, instala e reinicia o app.",
            ...
            .credentialsFooter: "Aqui, apenas uma chave do MiniMax Token Plan ou um token de acesso pessoal do QwenWork permite consultar cotas no servidor. O login do Codex é lido automaticamente; chaves de API corporativas do QwenWork não funcionam. As credenciais ficam nas Chaves do macOS.",
            ...
            .providerIcons: "Ícones de ferramentas de IA",
            .providerIconsHelp: "Só aparecem ferramentas com mais de um ícone oficial. A escolha atualiza imediatamente a barra lateral, a visão geral e a mascote.",
            .providerIconOpenAI: "Logo da OpenAI",
            .providerIconCodexLight: "Codex claro",
            .providerIconCodexDark: "Codex escuro",
        ...
        .russian: [
            ...
            .softwareUpdateHelp: "Проверяет GitHub Releases ежедневно в 11:00 по местному времени. Пропущенная проверка выполняется при запуске или пробуждении. Одно нажатие скачивает, проверяет, устанавливает обновление и перезапускает приложение.",
            ...
            .credentialsFooter: "Здесь серверные лимиты доступны только с ключом MiniMax Token Plan или личным токеном доступа QwenWork. Вход в Codex определяется автоматически; корпоративный API-ключ QwenWork не подходит. Учётные данные хранятся в Связке ключей macOS.",
            ...
            .providerIcons: "Значки ИИ-инструментов",
            .providerIconsHelp: "Здесь показаны только инструменты с несколькими официальными значками. Выбор сразу применяется в боковой панели, обзоре и информации о питомце.",
            .providerIconOpenAI: "Логотип OpenAI",
            .providerIconCodexLight: "Codex светлый",
            .providerIconCodexDark: "Codex тёмный",
